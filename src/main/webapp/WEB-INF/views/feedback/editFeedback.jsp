...
<head>
    ...
    <style>
       body {
               ...
               .form-control {
                   border-radius: 8px;
                   border: 1px solid #ced4da; /* added a border to the input fields */
                   padding: 10px;
                   font-size: 1rem;
               }
...
<body>
    ...
    <div class="container">
        <h1>Edit Feedback</h1>
        <form:form action="../edit" method="post" modelAttribute="feedbackCommand">
           ...
           <div class="form-group">
            ...
            <div class="button-container">
                ...
                <a href="<c:url value="/feedback/view/${feedbackCommand.feedbackId}" />" class="btn btn-default">Cancel</a>
            </div>
        </form:form>
    </div>
